  ...
  return (
    <div className="h-screen bg-gray-100 p-4">
      ...
      <div className="flex gap-6">
        <div className="w-2/3 max-h-[350px] overflow-auto rounded-lg">
          <span className="fw-bold">
            ...
            >
              ...
              <TableBody className="divide-y bg-gradient-to-b from-green-50 to-green-100">
                {products
                  .filter((m) =>
                    m.nom_medicament
                      .toLowerCase()
        ...
        <div className="bg-blue-600 rounded-2xl shadow p-5 text-white flex flex-col items-center space-y-4">
          <div className="text-center">
            <h3 className="text-2xl font-bold">Total:</h3>
            <p className="text-2xl font-extrabold">{total.toFixed(2)} DH</p>
          </div>
          <div className="text-center">
            <h3 className="text-2xl font-bold ">Nombre d'Articles:</h3>
            <p className="text-2xl font-extrabold">{totalarticle}</p>
          </div>
        </div>
      </div>
