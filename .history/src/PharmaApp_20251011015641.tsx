  ...
  return (
    <div className="h-screen bg-gray-100 p-4 bg-gradient-to-br from-emerald-50 to-emerald-100">
      ...
      <div className="flex gap-6">
        ...
        <div className="bg-white/70 backdrop-blur-md rounded-2xl shadow-lg p-6 flex flex-col items-center justify-center space-y-6 border border-gray-200">
          ...
          <div className="w-20 h-[2px] bg-gradient-to-r from-emerald-500 to-blue-600 rounded-full"></div>
