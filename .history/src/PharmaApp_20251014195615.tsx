  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-emerald-100 p-4">
      ...
      <div className="p-4 flex items-center gap-3">
        ...
        <button
          className="bg-gray-700 hover:bg-gray-800 text-white px-5 py-3 rounded font-semibold shadow transition"
          onClick={() => {
        ...
        <button
          className="bg-red-600 hover:bg-red-700 text-white px-5 py-3 rounded font-semibold shadow transition"
          onClick={confirmSale}
        >
          Confirmer
        </button>
                  ...
                  {filteredProducts.map((m, i) => (
                    <tr key={i} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-4 py-3 text-center">
                        <button
                          className="bg-gray-700 hover:bg-gray-800 text-white font-semibold px-3 py-1 rounded transition"
        ...
        <div className="flex gap-6">
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <div className="flex justify-center gap-2">
                            ...
                            <button
                              className="bg-gray-700 hover:bg-gray-800 text-white px-3 py-1 rounded text-sm transition"
                              onClick={() =>
          ...
          <div className="w-1/3 space-y-3">
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-gray-400 focus:outline-none text-sm"
            />
            <input
              type="text"
            ...
            <div className="flex gap-2">
              <button
                className="flex-1 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded font-semibold transition text-sm"
                onClick={() => setClientModalOpen(true)}
              >
                Crédit
              </button>
              <button
                className="flex-1 bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded font-semibold transition text-sm"
            ...
            <button
              ref={venteEspecesRef}
              className="w-full bg-gray-800 hover:bg-gray-900 text-white px-4 py-3 rounded font-semibold transition"
            ...
            <button
              ...
              className="w-full bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded font-semibold transition text-sm"
            >
              Traiter Avoir
            </button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded shadow-xl w-96">
            ...
            <input
              ...
              className="border border-gray-300 p-3 w-full mb-4 rounded focus:ring-2 focus:ring-gray-400 focus:outline-none"
              placeholder="Code..."
            />
            <div className="flex justify-end gap-2">
              <button
                className="bg-gray-700 hover:bg-gray-800 text-white px-5 py-2 rounded font-semibold transition"
                onClick={() => {
                  if (codeInput === "1234") {
