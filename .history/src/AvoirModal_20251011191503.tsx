...
const AvoirModal: React.FC<AvoirModalProps> = ({
  ...
  const processItem = async () => {
    ...
    try {
      // 1️⃣ Update or create stock in backend
      ...
      if (!stockResp.ok) throw new Error("Erreur mise à jour stock");

      // 2️⃣ Record the sale as "Avoir"
      ...
      setLog((prev) => [
        ...prev,
        { item: item.nom_medicament, success: true, message: `Avoir traité` },
      ]);
