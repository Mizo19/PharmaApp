...
const Header = ({ titre }: HeaderProps) => {
  ...
  return (
    <div className="relative bg-gradient-to-r from-[#1976d2] to-[#1565c0] text-white px-8 py-5 shadow-2xl font-serif">
      {/* Subtle top border accent */}
      <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-yellow-400 via-blue-300 to-yellow-400"></div>
      ...
      <div className="flex items-center justify-between max-w-[1600px] mx-auto">
        ...
        <div className="flex space-x-2 text-sm font-medium">
          <button
            className="hover:bg-white/15 transition-all duration-200 px-4 py-2.5 rounded-lg flex items-center gap-2 hover:shadow-lg backdrop-blur-sm"
            onClick={handleStock}
          >
        ...
        <div className="flex items-center space-x-3">
          <button
            className="hover:bg-white/15 transition-all duration-200 p-2.5 rounded-lg hover:shadow-lg backdrop-blur-sm"
          ...
          <button
            className="hover:bg-red-500/80 transition-all duration-200 p-2.5 rounded-lg hover:shadow-lg backdrop-blur-sm"
