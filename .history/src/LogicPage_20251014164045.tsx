...
export default function LogicPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 🔹 Vérifier le code utilisateur (nomUtilisateur)
      const foundUser = usersData.find(
        (u: any) =>
          u.nomUtilisateur.toLowerCase() === username.trim().toLowerCase() &&
      ...
      if (foundUser) {
        ...
        setError("Code utilisateur ou mot de passe incorrect");
      }
    } catch (err) {
      console.error(err);
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Saisir ou choisir un code"
                  required
                />
                {/* 🔹 Liste déroulante */}
